...
out='/u/home/p/phung428/nobackup-kirk/tanya_data/R_CpG/'${chrom}'_CpG.txt'

python compute_CpG.py --windows_bed ${windows} --targets_bed ${targets} --chr ${chrom} --outfile ${out}
