#!/bin/bash
workingDir=../../analyses/dog_human_divergence/download
axtFile='canFam3.hg19.net.axt'
...
sed -n '3~4p' ${workingDir}/${axtFile}_rmHeader > ${workingDir}/${axtFile}_rmHeader_hg19_sequence
