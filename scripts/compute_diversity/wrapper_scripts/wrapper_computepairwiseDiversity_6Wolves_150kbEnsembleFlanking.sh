...
targets=../../../results/get_target/compute_diversity/flanking_exons/callable_regions_withinSpecies_in_neutral_regions_150kbFlanking/6Wolves/6Wolves_chr${chrNum}_callableSites_in_neutralRegions.txt
variants=../../../results/compute_diversity/genotype_files_for_calc_diversity/chr${chrNum}/6Wolves.GT.FORMAT
numAllele=12
out=../../../results/compute_diversity/150kb_flanking/6Wolves/chr${chrNum}_6Wolves_diversity_150kbFlanking.txt
