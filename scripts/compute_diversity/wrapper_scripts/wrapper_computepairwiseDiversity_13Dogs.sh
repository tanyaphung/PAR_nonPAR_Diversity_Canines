...
targets=../../../results/get_target/compute_diversity/callable_regions_withinSpecies_in_neutral_regions/13Dogs/chr${chrNum}/13Dogs_chr${chrNum}_callableSites_in_neutralRegions.txt
