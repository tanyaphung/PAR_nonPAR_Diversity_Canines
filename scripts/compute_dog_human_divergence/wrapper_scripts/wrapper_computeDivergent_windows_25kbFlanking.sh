...
targets=../../../results/get_target/compute_diversity/flanking_exons/25kb/chr${i}/4_sort_merge_complement_ensembleFlanking.repeatMasker.microSat.simpleRepeats.bed
...
out=../../../results/compute_dog_human_divergence/25kb_flanking/chr${i}_Dog_Human_divergence_25kbFlanking.txt
