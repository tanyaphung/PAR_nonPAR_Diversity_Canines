...
targets=/u/project/klohmuel/tanya_data/PAR_nonPAR_Diversity_Canines/analyses/flanking_exons/125kb/chr${i}/4_sort_merge_complement_ensembleFlanking.repeatMasker.microSat.simpleRepeats.bed
...
out=/u/home/p/phung428/nobackup-kirk/tanya_data/R_divergence_flanking_exons/125kbFlanking/Dog_Human/chr${i}_Dog_Human_divergence_125kbFlanking.txt
