...
targets=../../../results/get_target/compute_diversity/flanking_exons/125kb/chr${i}/4_sort_merge_complement_ensembleFlanking.repeatMasker.microSat.simpleRepeats.bed
...
out=../../../results/compute_dog_human_divergence/125kb_flanking/chr${i}_Dog_Human_divergence_125kbFlanking.txt
