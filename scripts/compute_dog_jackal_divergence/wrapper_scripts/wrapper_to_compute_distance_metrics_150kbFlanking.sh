...
targets=../../../results/get_target/compute_divergence/callable_regions_in_neutral_regions_for_calc_distance/chrX/ddbox_RKWUCLA.gjtel_RKW1332_callable_sites_in_neutral_regions_150kbFlanking.bed
genotypes=../../../results/compute_diversity/genotype_files_for_calc_diversity/chr${chrNum}/6Wolves.GT.FORMAT
outFile=../../../results/compute_dog_jackal_divergence/150kbFlanking/chr${i}_Dog_Jackal_divergence_150kbFlanking.txt
