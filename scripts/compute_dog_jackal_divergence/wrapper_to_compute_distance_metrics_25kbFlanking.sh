...
#$ -cwd
#$ -V
#$ -N compute_distance_25kbFlanking
...
targets=/u/nobackup/kirk/phung428/tanya_data/callable_regions_in_neutral_regions_for_calc_distance/chrX/ddbox_RKWUCLA.gjtel_RKW1332_callable_sites_in_neutral_regions_25kbFlanking.bed
...
outFile=/u/home/p/phung428/nobackup-kirk/tanya_data/R_divergence_flanking_exons/25kbFlanking/Dog_Jackal/chr${i}_Dog_Jackal_divergence_25kbFlanking.txt
