...
outDir=../../results/compute_diversity_leave_one_out/13Dogs
...
vcftools --vcf ${inDir}/'chr'${chrNum}/${inVCF} $(for individual in "${leave_out_airedale[@]}"; do echo "--indv ${individual}"; done) --extract-FORMAT-info GT --out $outDir/leave_out_airedale/chr${chrNum}_leave_out_airedale

vcftools --vcf ${inDir}/'chr'${chrNum}/${inVCF} $(for individual in "${leave_out_basenji[@]}"; do echo "--indv ${individual}"; done) --extract-FORMAT-info GT --out $outDir/leave_out_basenji/chr${chrNum}_leave_out_basenji

vcftools --vcf ${inDir}/'chr'${chrNum}/${inVCF} $(for individual in "${leave_out_border_terrier[@]}"; do echo "--indv ${individual}"; done) --extract-FORMAT-info GT --out $outDir/leave_out_border_terrier/chr${chrNum}_leave_out_border_terrier

vcftools --vcf ${inDir}/'chr'${chrNum}/${inVCF} $(for individual in "${leave_out_black_russian[@]}"; do echo "--indv ${individual}"; done) --extract-FORMAT-info GT --out $outDir/leave_out_black_russian/chr${chrNum}_leave_out_black_russian

vcftools --vcf ${inDir}/'chr'${chrNum}/${inVCF} $(for individual in "${leave_out_jack_russell[@]}"; do echo "--indv ${individual}"; done) --extract-FORMAT-info GT --out $outDir/leave_out_jack_russell/chr${chrNum}_leave_out_jack_russell

vcftools --vcf ${inDir}/'chr'${chrNum}/${inVCF} $(for individual in "${leave_out_kerry_blue[@]}"; do echo "--indv ${individual}"; done) --extract-FORMAT-info GT --out $outDir/leave_out_kerry_blue/chr${chrNum}_leave_out_kerry_blue

vcftools --vcf ${inDir}/'chr'${chrNum}/${inVCF} $(for individual in "${leave_out_lab[@]}"; do echo "--indv ${individual}"; done) --extract-FORMAT-info GT --out $outDir/leave_out_lab/chr${chrNum}_leave_out_lab

vcftools --vcf ${inDir}/'chr'${chrNum}/${inVCF} $(for individual in "${leave_out_corgi[@]}"; do echo "--indv ${individual}"; done) --extract-FORMAT-info GT --out $outDir/leave_out_corgi/chr${chrNum}_leave_out_corgi

vcftools --vcf ${inDir}/'chr'${chrNum}/${inVCF} $(for individual in "${leave_out_scottish_terrier[@]}"; do echo "--indv ${individual}"; done) --extract-FORMAT-info GT --out $outDir/leave_out_scottish_terrier/chr${chrNum}_leave_out_scottish_terrier

vcftools --vcf ${inDir}/'chr'${chrNum}/${inVCF} $(for individual in "${leave_out_west_highland[@]}"; do echo "--indv ${individual}"; done) --extract-FORMAT-info GT --out $outDir/leave_out_west_highland/chr${chrNum}_leave_out_west_highland

vcftools --vcf ${inDir}/'chr'${chrNum}/${inVCF} $(for individual in "${leave_out_boxer[@]}"; do echo "--indv ${individual}"; done) --extract-FORMAT-info GT --out $outDir/leave_out_boxer/chr${chrNum}_leave_out_boxer
