...
variants=../../../results/compute_diversity_leave_one_out/genotype_files_for_calc_diversity/chr${chrNum}/chr${chrNum}_leave_out_lab.GT.FORMAT
numAllele=24
out=../../../results/compute_diversity_leave_one_out/13Dogs/leave_out_lab/chr${chrNum}_13Dogs_diversity_leave_out_lab.txt
