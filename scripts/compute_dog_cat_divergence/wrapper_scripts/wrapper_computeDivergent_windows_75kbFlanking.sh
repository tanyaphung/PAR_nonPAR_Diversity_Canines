...
targets=../../../results/get_target/compute_divergence/callable_regions_in_neutral_regions_for_calc_distance/chr${i}/ddbox_RKWUCLA.gjtel_RKW1332_callable_sites_in_neutral_regions_75kbFlanking.bed
...
out=../../../results/compute_dog_cat_divergence/75kb_flanking/chr${i}_Dog_Cat_divergence_75kbFlanking.txt
