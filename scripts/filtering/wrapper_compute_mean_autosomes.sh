...
do
Rscript compute_mean_autosomes.R /home/tanya/Dropbox/grad_school/Research/PAR_Canines_WorkComputer/analyses autosomes ${animal} >> autosomes_mean_diversity_divergence.txt
done
